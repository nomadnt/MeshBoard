...
<div class="page-header">
	<h3>
		<i class="glyphicon glyphicon-tasks"></i> @lang('network.list.title')
		<small>@lang('network.list.subtitle')</small>
	</h3>
</div>
	...
	<div class="col-lg-3">
		<div class="btn-group pull-right">
			<div class="input-group">
				...
				{{ Form::select('networks-refresh', $refreshes, 120, array('id' => 'networks-refresh', 'class' => 'form-control')) }}
			</div>
		</div>
	</div>
</div>
...
<table class="table table-striped table-bordered table-hover" width="100%">
	<thead>
		<tr>
			...
			<th data-hide="phone,tablet">@lang('Nodes')</th>
...
@section('scripts')
	...
	{{ HTML::script('js/network/index.js') }}
@stop